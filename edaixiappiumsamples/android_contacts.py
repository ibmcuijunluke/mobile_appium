...
class ContactsListAndroidTests(unittest.TestCase):
  def setUp(self):
    desired_caps = {}
    desired_caps['platformName'] = 'Android'
    desired_caps['platformVersion'] = '4.4'
  ...
  def test_add_contactslist(self):
    el = self.driver.find_element_by_name("Add Contact")
    el.click()
...
if __name__ == '__main__':
  ...
  suite = unittest.TestLoader().loadTestsFromTestCase(ContactsListAndroidTests)
